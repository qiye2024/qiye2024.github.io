...
ninja.data = [{
    ...
    handler: () => {
      ...
      handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-qi-s-work-climate-changes-drive-phytoplankton-community-through-complementarity-and-selection-effects-in-a-large-mesotrophic-reservoir-has-been-accepted-for-publication-in-journal-of-oceanology-and-limnology-sparkles-smile",
          title: 'Qi’s work, “Climate Changes Drive Phytoplankton Community Through Complementarity and Selection Effects in...',
          description: "",
          ...
          section: "News",handler: () => {
            ...
            },},{id: "news-qi-s-work-submitted-to-freshwater-biology-received-a-major-revision",
          title: 'Qi’s work submitted to Freshwater Biology received a major revision',
          description: "",
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%79%65.%71%69%32@%6E%6F%72%74%68%65%61%73%74%65%72%6E.%65%64%75", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/qi-ye-9659b5202", "_blank");
        },
      },{
        id: 'social-orcid',
        title: 'ORCID',
        section: 'Socials',
        handler: () => {
          window.open("https://orcid.org/0009-0002-9034-8010", "_blank");
        },
      },{
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://www.researchgate.net/profile/Qi_Ye8/", "_blank");
        },
      },{
        id: 'social-scholar',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=gMFijyoAAAAJ", "_blank");
        },
      },{
      id: 'light-theme',
